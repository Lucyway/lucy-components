...
$("#lay_f2").vegas({
    slides: [
        { src: "/_mod_files/ce_images/files/slide01.jpg" },
        { src: "/_mod_files/ce_images/files/slide02.jpg" },
        { src: "/_mod_files/ce_images/files/slide03.jpg" }
    ],
    animation: 'kenburns',
    animation: 'random',
    delay: 7000,
    ...
    overlay: '/_mod_files/ce_images/files/01.png',
});
